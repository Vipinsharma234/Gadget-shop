...
const Signin = () => {
  ...
  return (
    <div className="flex items-center justify-center p-5  ">
      <div className="border-1 border-purple-500 flex rounded-lg">
        <div className="left">
           <Lottie
            animationData={Login}
            loop={true}
        ...
        <div className="rounded-lg p-5  ">
          ...
          >
            ...
            <button
              className="px-3 py-1 border-1 border-purple-500 rounded-2xl  bg-gradient-to-r from-red-500 to-green-400  cursor-pointer"
              type="submit"
            >
              {" "}
              Signin
